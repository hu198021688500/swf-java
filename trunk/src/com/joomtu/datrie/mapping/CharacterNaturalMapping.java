...
public class CharacterNaturalMapping implements NaturalMapping<Character> {
	...
	private static final CharacterNaturalMapping instance = new CharacterNaturalMapping();
	...
	/**
	 * @see com.joomtu.datrie.mapping.NaturalMapping#getN()
	 */
	@Override
	public int getN() {
		return N;
	...
	/**
	 * @see com.joomtu.datrie.mapping.NaturalMapping#fromNatural(int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.mapping.NaturalMapping#toNatural(java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.mapping.NaturalMapping#getUnmapped()
	 */
	@Override
