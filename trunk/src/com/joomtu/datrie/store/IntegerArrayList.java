...
public class IntegerArrayList implements IntegerList {
	 ...
	 */
	IntegerArrayList(int initialCapacity, int incRatioNom, int incRatioDenom,
			int fixedInc) {
	...
	private void ensureCapacity(int capacity) {
		...
		if (capacity > oldCapacity) {
			int newCapacity = (oldCapacity * INCREASE_RATIO_NUMERATOR)
					/ INCREASE_RATIO_DENOMINATOR + FIXED_INCREASE;
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#size()
	 */
	@Override
	public int size() {
		return size;
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#isEmpty()
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#get(int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#set(int, int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#add(int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#add(int, int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerList#remove(int)
	 */
	@Override
