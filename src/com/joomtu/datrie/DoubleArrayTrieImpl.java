...
import com.joomtu.datrie.store.IntegerArrayListFactory;
import com.joomtu.datrie.store.IntegerList;
import com.joomtu.datrie.store.IntegerListFactory;
...
public class DoubleArrayTrieImpl extends AbstractDoubleArrayTrie {
	...
	/**
	 * Constructs a DoubleArrayTrie for the given alphabet length. Uses a
	 * default IntegerArrayList for storage.
	 * 
	...
	/**
	 * Constructs a DoubleArrayTrie for the given alphabet length that uses the
	 * provided IntegerListFactory for creating the storage.
	 * 
	 * @param alphabetLength
	 *            The size of the set of values that are to be stored.
	 * @param listFactory
	 ...
	 */
	public DoubleArrayTrieImpl(int alphabetLength,
			IntegerListFactory listFactory) {
	...
	/**
	 * Ensures that the index == <tt>limit</tt> is available from the backing
	 * arrays. If it already available, this call is almost zero overhead.
	 * 
	 * @param limit
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#nextAvailableHop(int)
	 */
	@Override
	protected int nextAvailableHop(int forValue) {
		...
		/*
		 * First we make sure that there exists a free location that is strictly
		 * greater than the value.
		 */
		while (freePositions.higher(value) == null) {
			ensureReachableIndex(base.size() + 1); // This adds to the
													// freePositions store
		}
		/*
		 * From the termination condition of the loop above, the next line
		 * CANNOT throw NullPointerException Note that we return the position
		 * minus the value. That is because the result is the ordinal of the new
		 * state which is translated to a store index. Therefore, since we add
		 * the value to the base to find the next state, here we must subtract.
		 */
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#nextAvailableMove(java.util.SortedSet)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#getBase(int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#getCheck(int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#setBase(int, int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#setCheck(int, int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#getSize()
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#updateSearch(int, int,
	 *      com.joomtu.datrie.store.IntegerList)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#updateInsert(int, int,
	 *      com.joomtu.datrie.store.IntegerList)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#updateChildMove(int, int,
	 *      int)
	 */
	@Override
	...
	/**
	 * @see com.joomtu.datrie.AbstractDoubleArrayTrie#updateStateMove(int, int)
	 */
	@Override
