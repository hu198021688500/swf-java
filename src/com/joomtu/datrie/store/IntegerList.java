...
/**
 * Simple interface defining the behaviour of something like but not quite, of
 * an ArrayList but without generic support, just enough for storing integers.
 * There. In other words, this is the small, retarded cousin of List&lt;int&gt;
 * (note the primitive int).
 * 
 * @author Chris Gioran
 * 
 */
public interface IntegerList {
	 ...
	 * 
	 * @param value
	 *            value to be appended to this list
