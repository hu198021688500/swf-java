...
public class IntegerArrayListFactory implements IntegerListFactory {
	 ...
	 */
	private IntegerArrayListFactory(int initialCapacity, int numerator,
			int denominator, int fixedInc) {
	...
	/**
	 * Creates and returns an <tt>IntegerListFactory</tt> that manufactures
	 * <tt>IntegerArrayList</tt>s with an initial capacity of
	 * <tt>initialCapacity</tt> and a growth factor of
	 * <p>
	 * <tt>numerator/denominator + fixedInc</tt>
	 * 
	 * @param initialCapacity
	 *            The initialCapacity of the Array
	 * @param numerator
	 * @param denominator
	 * @param fixedInc
	 * @return
	 */
	public static IntegerArrayListFactory newInstance(int initialCapacity,
			int numerator, int denominator, int fixedInc) {
		return new IntegerArrayListFactory(initialCapacity, numerator,
				denominator, fixedInc);
	}

	/**
	 * Creates and returns an <tt>IntegerListFactory</tt> that manufactures
	 * <tt>IntegerArrayList</tt>s with an initial capacity of 16 and a growth
	 * factor of 5/4 + 10.
	 * 
	...
	/**
	 * @see com.joomtu.datrie.store.IntegerListFactory#getNewIntegerList()
	 */
	public IntegerList getNewIntegerList() {
		return new IntegerArrayList(initialCapacity, numerator, denominator,
				fixedInc);
	}
}
